...
class Hand(object):
    ...
    myHand = Hand(9)
    myHand.setDummyHand('rraajrrdq')
    myHand.update(boar): False
    print myHand
    aadjqrrrr

    myHand = Hand(8)
    myHand.setDummyHand('tttcqgyq')
    myHand.update(tea): False
    print myHand
    cgqqttty

    myHand = Hand(9)
    myHand.setDummyHand('bobosirbn')
    myHand.update(boar): False
    print myHand
    bbbinoors

    myHand = Hand(9)
    myHand.setDummyHand('ahhailxhk')
